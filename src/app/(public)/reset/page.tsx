...
export default function ResetPage(): React.JSX.Element {
    return (
        <Suspense
            fallback={
                <div className="min-h-dvh grid place-items-center text-sm text-white/50" style={{ background: "url('/images/Untitled.png') center top / cover no-repeat", backgroundColor: "#050010" }}>
                    Carregando...
                </div>
            }
        >
...
function ResetInner(): React.JSX.Element {
    ...
    if (!token) {
        return (
            <div className="min-h-dvh grid place-items-center px-4" style={{ background: "url('/images/Untitled.png') center top / cover no-repeat", backgroundColor: "#050010" }}>

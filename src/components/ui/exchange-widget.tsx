...
const ExchangeWidget = () => {
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-[520px] bg-white/90 backdrop-blur-xl rounded-2xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.12)] p-5 border border-slate-100 relative overflow-hidden"
    >
      ...
      <div className="flex items-center gap-3 relative z-10">
        <div className="flex-1 bg-slate-50/80 rounded-xl p-4 border border-slate-100">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Você envia</span>
            <div className="flex items-center gap-1.5 bg-white px-2 py-0.5 rounded-full border border-slate-100">
              <img src="https://flagcdn.com/w20/br.png" alt="BR" className="w-3.5 h-2.5 rounded-sm object-cover" />
              <span className="text-[10px] font-bold text-slate-600">BRL</span>
            </div>
          </div>
        ...
        <div className="flex-1 bg-primary/[0.04] rounded-xl p-4 border border-primary/10">
          <div className="flex items-center justify-between mb-2">
            <span className="text-[10px] font-bold text-primary/50 uppercase tracking-wider">Você recebe</span>
            <div className="flex items-center gap-1.5 bg-white px-2 py-0.5 rounded-full border border-primary/10">
              <div className="w-3.5 h-3.5 rounded-full bg-[#26A17B] flex items-center justify-center">
      ...
      <div className="flex items-center justify-between mt-4 relative z-10">
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          className="flex-1 py-3 bg-slate-900 text-white text-sm font-bold rounded-xl shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center gap-2"
        >
          <span>Iniciar Conversão</span>
          <TrendingUp className="w-4 h-4 text-primary" />
        </motion.button>
        <div className="ml-3 text-[10px] font-bold text-emerald-500 bg-emerald-50 px-2.5 py-1.5 rounded-lg border border-emerald-100/50">
          0% fee
        </div>
      </div>
    </motion.div>

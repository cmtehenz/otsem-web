            ...
            <BottomSheetContent>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex gap-3">
                            ...
                            <Button
                                ...
                                className="flex-1 bg-gradient-to-r from-[#3871F1] to-[#3871F1] hover:from-[#234FB3] hover:to-[#3871F1] text-white"
                            >
                                Enviar Solicitação
                ...
                {step === "success" && (
                    <div className="py-10 text-center">
                        ...
                        <Button
                            onClick={handleClose}
                            className="mt-6 bg-gradient-to-r from-[#3871F1] to-[#3871F1] hover:from-[#234FB3] hover:to-[#3871F1] text-white"
                        >
                            Entendi
                        </Button>
                    </div>
